...
export const profile = {
  ...
  tagline:   'Pelajar SMK Wikrama Bogor yang passionate di dunia web & digital.',
  about1:    'Halo! Saya Queentana — programmer Pelajar SMK Wikrama Bogor jurusan PPLG (Pengembangan Perangkat Lunak dan Gim). Saya sedang aktif mencari pengalaman di dunia industri, khususnya di bidang Web Developer / Frontend.',
  ...
  email:     'alleaqueentana@gmail.com',
...
export const skills = [
  ...
  },
  {
    name: 'Flutter',
    level: 65,
    desc: 'Membangun aplikasi mobile cross-platform untuk Android dan iOS menggunakan Flutter dan bahasa Dart.',
    icon: 'SiFlutter',
  },
  {
    name: 'Laravel',
    level: 70,
    desc: 'Mengembangkan aplikasi web backend menggunakan Laravel dengan fitur seperti routing, eloquent ORM, dan RESTful API.',
    icon: 'SiLaravel',
  },
  {
    name: 'React',
    level: 68,
    desc: 'Membangun antarmuka web yang dinamis dan interaktif menggunakan React, hooks, dan component-based architecture.',
    icon: 'FaReact',
  },
]
...
export const projects = [
 ...
 },
 {
  ...
  tech: ["Figma"],
  figma : 'https://www.figma.com/design/iDCfaomQbdRqV8KISfAZ6f/Eccomerce-Qfruit?m=auto&t=xKpwtwxymn8yB2k6-1',
  demo:'https://www.figma.com/proto/iDCfaomQbdRqV8KISfAZ6f?node-id=0-1&t=xKpwtwxymn8yB2k6-6',
 ...
 },
 {
  ...
  demo:'https://www.figma.com/proto/QCCCwxbBNZCKKzrn0siwP1?node-id=0-1&t=xKpwtwxymn8yB2k6-6',
...
export const certificates = [
  ...
  },
  {
  ...
  },
   {
    ...
    color: '#f5f0ff',
    borderColor: '#ddd6fe',
    desc: 'Mempelajari  Dasar Sebagai Web develompt Materi yang dipelajari meliputi struktur HTML, desain menggunakan CSS, interaktivitas dengan JavaScript, serta penerapan responsive web design untuk membangun tampilan website yang optimal di berbagai perangkat. ',
  },
   {
    id: 8,
    ...
    color: '#f5f0ff',
    borderColor: '#ddd6fe',
    desc: 'Mempelajari dasar-dasar pengembangan web, mulai dari struktur halaman menggunakan HTML, desain tampilan dengan CSS, hingga interaktivitas menggunakan JavaScript. Memahami konsep website modern, responsive design, serta alur kerja dasar dalam pembuatan aplikasi web.',
  },
   {
    id: 9,
    ...
    color: '#f5f0ff',
    borderColor: '#ddd6fe',
    desc: 'Mempelajari prinsip dasar User Experience (UX) Design dalam merancang produk digital yang mudah digunakan dan nyaman bagi pengguna. Materi mencakup user research, wireframing, prototyping, usability, serta penerapan desain yang berfokus pada kebutuhan pengguna.',
  },
   {
    id: 10,
    ...
    color: '#f5f0ff',
    borderColor: '#ddd6fe',
    desc: 'Mempelajari pentingnya keselamatan dan kesehatan kerja (K3) untuk menciptakan lingkungan kerja yang aman, sehat, dan produktif. Materi mencakup identifikasi risiko kerja, prosedur keselamatan, pencegahan kecelakaan, serta penerapan budaya kerja yang disiplin dan bertanggung jawab.',
  },
]
